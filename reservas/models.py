...
class Reserva(models.Model):
    usuario = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, blank=True) #opcional y permitir null (es temporal apra ver si funciona el resitro nomas)
